...
public class UserOfComparability {
    ...
    public static void main(String[] commandLine) {
		...
		// Dates
		Date d0 = new Date(2019, 4, 3); // yesterday
		reportRelationship( "Date vs. itself", d0, d0, "0");
		reportRelationship( "Date vs. close date"
                          , d0, new Date(2019, 4, 4), "negative int");
		reportRelationship( "Date vs. far date"
                          , d0, new Date(1032, 12, 18), "positive int");
						  
		// Dogs
		// reportRelationship( "Dog vs. itself", new IncomparableDog(), new IncomparableDog(), "ERROR");
			// error: incompatible types: IncomparableDog cannot be converted to Comparable
			
		// Date vs Point
		// reportRelationship("Date vs Point", p0, d0, "ERROR");
